...
## Translations
Here is a list of languages the mod currently supports. If you would like to add translations, the localization files can be found [here](../../tree/dev/[JA]AdvancedCharcoalKilns/i18n).
|Language|Status|
|-|-|
