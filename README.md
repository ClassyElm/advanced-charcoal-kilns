...
## Translations
Here is a list of languages the mod currently supports. If you would like to add translations, the localization files can be found [here](advanced-charcoal-kilns/tree/dev/[JA]%20Advanced%20Charcoal%20Kilns/i18nn).
|Language|Status|
|-|-|
